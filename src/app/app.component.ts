...
export class AppComponent {
  ...
  public cliente = {
    "client": "CACAO DEMO",
    "id_country": "VE",
    "img_cliente": "20200205180258.png",
    "web": "https://cacao.ilstechnik.com",
    "urlPrueba": "https://cacao.ilstechnik.com",
    "prefix": "CCD",
    "type_platform": "1",
    "id_broker": "118",
    "email": "info@cacao.com",
    "colors_platform": "{ \"COLOR_MENU_BACKEND\": \"#663399\", \"color_tr_table\": \"#bababa\", \"color_font_tr\": \"#e6e1e1\", \"color_login\": \"#f6f6f6\", \"color_menu\": \"#7276b5\", \"color_menu_barra\": \"#212121\", \"color_menu_barra_hover\": \"#66635F\", \"color_font_tab\": \"#5c595a\", \"color_email_font\": \"#065c96\", \"email_shadow_table\": \"#f9f9f9\" }"
  };
  ...
  constructor(public platform: Platform,
    ...
    if (localStorage.getItem('userType')) {
      ...
      navCtrl.navigateRoot('/login/CCD');
    }
    ...
    network.onConnect().subscribe(() => {
      ...
      this.userType ? this.navCtrl.navigateRoot('/list-orders') : navCtrl.navigateRoot('/login/CCD');;
  ...
  sessionColores(colorsPlatform, cliente) {
    if (localStorage.getItem('paramAgency') != 'N/A' && localStorage.getItem('paramAgency')) {
      ...
      localStorage.setItem("nomClient", 'Cacao Demo');
    }
  }
